...
static long getSeed() {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            StdRandom.println("%2d ",   uniform(100));
            StdRandom.println("%8.5f ", uniform(10.0, 99.0));
            StdRandom.println("%5b ",   bernoulli(0.5));
            StdRandom.println("%7.5f ", gaussian(9.0, 0.2));
            StdRandom.println("%1d ",   discrete(probabilities));
            StdRandom.println("%1d ",   discrete(frequencies));
            StdRandom.println("%11d ",  uniform(100000000000L));
            StdRandom.shuffle(a);
            for (String s : a)
                StdOut.println(s);
            StdOut.println(null);
